...
</style><style>.heading>.grow{flex:1}.left-mode-toggle{display:inline-flex;height:27px;align-items:stretch}.heading .left-mode-toggle button{width:auto;height:27px;padding:0 7px;border:0;border-bottom:2px solid transparent;background:transparent;color:var(--vscode-descriptionForeground)}.heading .left-mode-toggle button:hover{color:var(--vscode-foreground)}.heading .left-mode-toggle button.active{color:var(--vscode-foreground);border-bottom-color:var(--vscode-focusBorder);background:var(--vscode-toolbar-hoverBackground)}.stash-count:empty{display:none}.stash-item{position:relative;display:grid!important;grid-template-columns:20px minmax(0,1fr);height:42px!important;padding-top:4px!important;padding-bottom:4px!important}.stash-copy{min-width:0;overflow:hidden}.stash-message,.stash-meta{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.stash-message{line-height:18px}.stash-meta{color:var(--vscode-descriptionForeground);font-size:10px;line-height:14px}.stash-actions{position:absolute;right:4px;top:10px;display:inline-flex;visibility:hidden;align-items:center;gap:2px;padding-left:8px;background:linear-gradient(90deg,transparent,var(--vscode-list-hoverBackground) 8px)}.stash-item:hover .stash-actions,.stash-item:focus-within .stash-actions{visibility:visible}.stash-action{width:auto!important;height:22px!important;padding:0 5px!important;border:0!important;border-radius:3px;background:transparent!important;color:var(--vscode-descriptionForeground)}.stash-action:hover,.stash-action:focus-visible{color:var(--vscode-foreground);background:var(--vscode-toolbar-hoverBackground)!important;outline:1px solid var(--vscode-focusBorder);outline-offset:-1px}.stash-action.danger{color:var(--vscode-errorForeground)}
</style></head><body>
