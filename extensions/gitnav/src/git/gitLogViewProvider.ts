...
.recovery-modal-card{width:min(480px,calc(100vw - 30px))}.recovery-modal-card h3{margin:0 0 7px}.recovery-modal-card p{margin:0 0 12px;color:var(--vscode-descriptionForeground)}.recovery-modal-card details{margin-top:10px;color:var(--vscode-descriptionForeground)}.recovery-modal-card pre{max-height:150px;overflow:auto;white-space:pre-wrap;font:11px var(--vscode-editor-font-family)}
</style></head><body>
